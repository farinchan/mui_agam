...
@section('seo')
    ...
    <meta property="og:url" content="{{ route('pengumuman.detail',  $event->slug) }}">
    <link rel="canonical" href="{{ route('pengumuman.detail', $event->slug) }}">
                        ...
                        <div class="single-post">
                            ...
                            <div class="blog_details">
                                ...
                                <ul class="blog-info-link mt-3 mb-4">
                                    <li><a href="#"><i class="fa fa-user"></i> {{ $event->user->name }}</a></li>
                                    </li>
                                    <li>
                                        <a href="#"> {{ $event->created_at->format('d F Y') }}</a>
                                    </li>
                                </ul>

                                <table class="table table-borderless">
                                    <tr>
                                        <td width="150px">Waktu Dari</td>
                                        <td width="10px">:</td>
                                        <td>{{ Carbon\Carbon::parse($event->start)->format('d F Y H:i') }}</td>
                                    </tr>
                                    <tr>
                                        <td>Waktu Hingga</td>
                                        <td>:</td>
                                        <td>{{ Carbon\Carbon::parse($event->end)->format('d F Y H:i') }}</td>
                                    </tr>
                                </table>
